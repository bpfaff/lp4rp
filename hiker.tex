...
\LA{}man-HikeR-bursts~{\nwtagstyle{}\subpageref{RNWhik1-man50-1}}\RA{}
setMethod("bursts",
    signature(object = "HikeR"),
...
\LA{}man-HikeR-busts~{\nwtagstyle{}\subpageref{RNWhik1-man51-1}}\RA{}
setMethod("busts",
    signature(object = "HikeR"),
    function (object, h = 0, b = object@k) \{
        lpts <- object@ys[, 2] < h
...
\LA{}man-HikeR-ridges~{\nwtagstyle{}\subpageref{RNWhik1-man52-1}}\RA{}
setMethod("ridges",
    signature(object = "HikeR"),
    function (object, h = 0, b = object@k) \{
        N <- nrow(object@ys)
...
\LA{}man-HikeR-phases~{\nwtagstyle{}\subpageref{RNWhik1-man53-1}}\RA{}
setMethod("phases",
    signature(object = "HikeR"),
    function (object, h = 0, b = object@k) \{
        N <- nrow(object@ys)
...
\LA{}man-HikeR-topeaks~{\nwtagstyle{}\subpageref{RNWhik1-man54-1}}\RA{}
setMethod("topeaks",
    signature(object = "HikeR"),
    function (object, h = 0) \{
        N <- nrow(object@ys)
...
\LA{}man-HikeR-totroughs~{\nwtagstyle{}\subpageref{RNWhik1-man55-1}}\RA{}
setMethod("totroughs",
    signature(object = "HikeR"),
    function (object, h = 0) \{
...
\LA{}man-HikeR-plot~{\nwtagstyle{}\subpageref{RNWhik1-man56-1}}\RA{}
setMethod("plot",
    ...
    function (x, type = c("series", "score", "both", "zoo"),
              ...
              ...)\{
        \LA{}plotinit~{\nwtagstyle{}\subpageref{RNWhik1-plo33-1}}\RA{}
        \LA{}plotscore~{\nwtagstyle{}\subpageref{RNWhik1-plo34-1}}\RA{}
        \LA{}plotseries~{\nwtagstyle{}\subpageref{RNWhik1-plo35-1}}\RA{}
        \LA{}plotboth~{\nwtagstyle{}\subpageref{RNWhik1-plo38-1}}\RA{}
        \LA{}plotzoo~{\nwtagstyle{}\subpageref{RNWhik1-plo39-1}}\RA{}
    \}
)
\nwendcode{}\nwbegindocs{62}@
...
\nwenddocs{}\nwbegincode{63}\sublabel{RNWhik1-plo33-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-plo33-1}}}\moddef{plotinit~{\nwtagstyle{}\subpageref{RNWhik1-plo33-1}}}\endmoddef
type <- match.arg(type)
...
\nwenddocs{}\nwbegincode{65}\sublabel{RNWhik1-plo34-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-plo34-1}}}\moddef{plotscore~{\nwtagstyle{}\subpageref{RNWhik1-plo34-1}}}\endmoddef
if ( type == "score" )\{
...
\nwenddocs{}\nwbegincode{67}\sublabel{RNWhik1-plo35-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-plo35-1}}}\moddef{plotseries~{\nwtagstyle{}\subpageref{RNWhik1-plo35-1}}}\endmoddef
if ( type == "series" )\{
    ...
    do.call(graphics::points, c(list(y = ynum, x = troughidx),
                                pt.trough))
    \LA{}plotbb~{\nwtagstyle{}\subpageref{RNWhik1-plo36-1}}\RA{}
    \LA{}plotpt~{\nwtagstyle{}\subpageref{RNWhik1-plo37-1}}\RA{}
    graphics::box()
...
\nwenddocs{}\nwbegincode{69}\sublabel{RNWhik1-plo36-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-plo36-1}}}\moddef{plotbb~{\nwtagstyle{}\subpageref{RNWhik1-plo36-1}}}\endmoddef
if ( phase  == "bb" )\{
    p <- phases(x, h = h, b = b)
...
\nwenddocs{}\nwbegincode{71}\sublabel{RNWhik1-plo37-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-plo37-1}}}\moddef{plotpt~{\nwtagstyle{}\subpageref{RNWhik1-plo37-1}}}\endmoddef
if ( phase == "pt" )\{
    top <- topeaks(x, h)
    topr <- runs(top)
    tot <- totroughs(x, h)
...
\nwenddocs{}\nwbegincode{73}\sublabel{RNWhik1-plo38-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-plo38-1}}}\moddef{plotboth~{\nwtagstyle{}\subpageref{RNWhik1-plo38-1}}}\endmoddef
if ( type == "both" )\{
...
\nwenddocs{}\nwbegincode{75}\sublabel{RNWhik1-plo39-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-plo39-1}}}\moddef{plotzoo~{\nwtagstyle{}\subpageref{RNWhik1-plo39-1}}}\endmoddef
if ( type == "zoo" )\{
    plot(x@ys, ...)
\}
\nwendcode{}\nwbegindocs{76}@
...
\nwenddocs{}\nwbegincode{77}\sublabel{RNWhik1-Ptb40-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-Ptb40-1}}}\moddef{PtbbMethods.R~{\nwtagstyle{}\subpageref{RNWhik1-Ptb40-1}}}\endmoddef\let\nwnotused=\nwoutput{}
\LA{}man-PTBB-runs~{\nwtagstyle{}\subpageref{RNWhik1-man57-1}}\RA{}
setMethod("runs",
...
\nwenddocs{}\nwbegincode{79}\sublabel{RNWhik1-hik41-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-hik41-1}}}\moddef{hikerEx.R~{\nwtagstyle{}\subpageref{RNWhik1-hik41-1}}}\endmoddef\let\nwnotused=\nwoutput{}
library(hiker)
TEX <- SP500[, "TEX"]
...
\nwenddocs{}\nwbegincode{95}\sublabel{RNWhik1-man49-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man49-1}}}\moddef{man-HikeR-troughs~{\nwtagstyle{}\subpageref{RNWhik1-man49-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases troughs
#' @export
\nwendcode{}\nwbegindocs{96}@

\nwenddocs{}\nwbegincode{97}\sublabel{RNWhik1-man50-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man50-1}}}\moddef{man-HikeR-bursts~{\nwtagstyle{}\subpageref{RNWhik1-man50-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases bursts
...
\nwenddocs{}\nwbegincode{99}\sublabel{RNWhik1-man51-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man51-1}}}\moddef{man-HikeR-busts~{\nwtagstyle{}\subpageref{RNWhik1-man51-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases busts
#' @export
\nwendcode{}\nwbegindocs{100}@

\nwenddocs{}\nwbegincode{101}\sublabel{RNWhik1-man52-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man52-1}}}\moddef{man-HikeR-ridges~{\nwtagstyle{}\subpageref{RNWhik1-man52-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases ridges
#' @export
\nwendcode{}\nwbegindocs{102}@

\nwenddocs{}\nwbegincode{103}\sublabel{RNWhik1-man53-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man53-1}}}\moddef{man-HikeR-phases~{\nwtagstyle{}\subpageref{RNWhik1-man53-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases phases
#' @export
\nwendcode{}\nwbegindocs{104}@

\nwenddocs{}\nwbegincode{105}\sublabel{RNWhik1-man54-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man54-1}}}\moddef{man-HikeR-topeaks~{\nwtagstyle{}\subpageref{RNWhik1-man54-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases topeaks
#' @export
\nwendcode{}\nwbegindocs{106}@

\nwenddocs{}\nwbegincode{107}\sublabel{RNWhik1-man55-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man55-1}}}\moddef{man-HikeR-totroughs~{\nwtagstyle{}\subpageref{RNWhik1-man55-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases totroughs
#' @export
\nwendcode{}\nwbegindocs{108}@

\nwenddocs{}\nwbegincode{109}\sublabel{RNWhik1-man56-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man56-1}}}\moddef{man-HikeR-plot~{\nwtagstyle{}\subpageref{RNWhik1-man56-1}}}\endmoddef
#' @rdname HikeR-class
#' @aliases plot
...
\nwenddocs{}\nwbegincode{111}\sublabel{RNWhik1-man57-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-man57-1}}}\moddef{man-PTBB-runs~{\nwtagstyle{}\subpageref{RNWhik1-man57-1}}}\endmoddef
#' @rdname PTBB-class
#' @aliases runs
...
\nwenddocs{}\nwbegincode{113}\sublabel{RNWhik1-dat58-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-dat58-1}}}\moddef{data.R~{\nwtagstyle{}\subpageref{RNWhik1-dat58-1}}}\endmoddef\let\nwnotused=\nwoutput{}
...
\nwenddocs{}\nwbegincode{115}\sublabel{RNWhik1-lpd59-1}\nwmargintag{{\nwtagstyle{}\subpageref{RNWhik1-lpd59-1}}}\moddef{lpdoc.R~{\nwtagstyle{}\subpageref{RNWhik1-lpd59-1}}}\endmoddef\let\nwnotused=\nwoutput{}
...
\nwixlogsorted{c}{{data.R}{RNWhik1-dat58-1}{\nwixd{RNWhik1-dat58-1}}}%
...
\nwixlogsorted{c}{{hikerEx.R}{RNWhik1-hik41-1}{\nwixd{RNWhik1-hik41-1}}}%
\nwixlogsorted{c}{{HikerMethods.R}{RNWhik1-Hik21-1}{\nwixd{RNWhik1-Hik21-1}}}%
\nwixlogsorted{c}{{lpdoc.R}{RNWhik1-lpd59-1}{\nwixd{RNWhik1-lpd59-1}}}%
\nwixlogsorted{c}{{man-class-HikeR}{RNWhik1-man44-1}{\nwixd{RNWhik1-man44-1}\nwixu{RNWhik1-Hik18-1}}}%
\nwixlogsorted{c}{{man-class-PTBB}{RNWhik1-man45-1}{\nwixd{RNWhik1-man45-1}\nwixu{RNWhik1-Ptb19-1}}}%
\nwixlogsorted{c}{{man-func-hiker}{RNWhik1-man43-1}{\nwixd{RNWhik1-man43-1}\nwixu{RNWhik1-hik14-1}}}%
\nwixlogsorted{c}{{man-func-score}{RNWhik1-man42-1}{\nwixd{RNWhik1-man42-1}\nwixu{RNWhik1-sco10-1}}}%
\nwixlogsorted{c}{{man-HikeR-bursts}{RNWhik1-man50-1}{\nwixd{RNWhik1-man50-1}\nwixu{RNWhik1-Hik26-1}}}%
\nwixlogsorted{c}{{man-HikeR-busts}{RNWhik1-man51-1}{\nwixd{RNWhik1-man51-1}\nwixu{RNWhik1-Hik27-1}}}%
\nwixlogsorted{c}{{man-HikeR-peaks}{RNWhik1-man48-1}{\nwixd{RNWhik1-man48-1}\nwixu{RNWhik1-Hik24-1}}}%
\nwixlogsorted{c}{{man-HikeR-phases}{RNWhik1-man53-1}{\nwixd{RNWhik1-man53-1}\nwixu{RNWhik1-Hik29-1}}}%
\nwixlogsorted{c}{{man-HikeR-plot}{RNWhik1-man56-1}{\nwixd{RNWhik1-man56-1}\nwixu{RNWhik1-Hik32-1}}}%
\nwixlogsorted{c}{{man-HikeR-ridges}{RNWhik1-man52-1}{\nwixd{RNWhik1-man52-1}\nwixu{RNWhik1-Hik28-1}}}%
\nwixlogsorted{c}{{man-HikeR-show}{RNWhik1-man46-1}{\nwixd{RNWhik1-man46-1}\nwixu{RNWhik1-Hik22-1}}}%
\nwixlogsorted{c}{{man-HikeR-summary}{RNWhik1-man47-1}{\nwixd{RNWhik1-man47-1}\nwixu{RNWhik1-Hik23-1}}}%
\nwixlogsorted{c}{{man-HikeR-topeaks}{RNWhik1-man54-1}{\nwixd{RNWhik1-man54-1}\nwixu{RNWhik1-Hik30-1}}}%
\nwixlogsorted{c}{{man-HikeR-totroughs}{RNWhik1-man55-1}{\nwixd{RNWhik1-man55-1}\nwixu{RNWhik1-Hik31-1}}}%
\nwixlogsorted{c}{{man-HikeR-troughs}{RNWhik1-man49-1}{\nwixd{RNWhik1-man49-1}\nwixu{RNWhik1-Hik25-1}}}%
\nwixlogsorted{c}{{man-PTBB-runs}{RNWhik1-man57-1}{\nwixd{RNWhik1-man57-1}\nwixu{RNWhik1-Ptb40-1}}}%
\nwixlogsorted{c}{{NAMESPACE}{RNWhik1-NAM17-1}{\nwixd{RNWhik1-NAM17-1}\nwixu{RNWhik1-All16-1}}}%
\nwixlogsorted{c}{{plotbb}{RNWhik1-plo36-1}{\nwixd{RNWhik1-plo36-1}\nwixu{RNWhik1-plo35-1}}}%
\nwixlogsorted{c}{{plotboth}{RNWhik1-plo38-1}{\nwixd{RNWhik1-plo38-1}\nwixu{RNWhik1-Hik32-1}}}%
\nwixlogsorted{c}{{plotinit}{RNWhik1-plo33-1}{\nwixd{RNWhik1-plo33-1}\nwixu{RNWhik1-Hik32-1}}}%
\nwixlogsorted{c}{{plotpt}{RNWhik1-plo37-1}{\nwixd{RNWhik1-plo37-1}\nwixu{RNWhik1-plo35-1}}}%
\nwixlogsorted{c}{{plotscore}{RNWhik1-plo34-1}{\nwixd{RNWhik1-plo34-1}\nwixu{RNWhik1-Hik32-1}}}%
\nwixlogsorted{c}{{plotseries}{RNWhik1-plo35-1}{\nwixd{RNWhik1-plo35-1}\nwixu{RNWhik1-Hik32-1}}}%
\nwixlogsorted{c}{{plotzoo}{RNWhik1-plo39-1}{\nwixd{RNWhik1-plo39-1}\nwixu{RNWhik1-Hik32-1}}}%
\nwixlogsorted{c}{{PtbbClass}{RNWhik1-Ptb19-1}{\nwixd{RNWhik1-Ptb19-1}\nwixu{RNWhik1-All16-1}}}%
\nwixlogsorted{c}{{PtbbMethods.R}{RNWhik1-Ptb40-1}{\nwixd{RNWhik1-Ptb40-1}}}%
